# Exp 1: MERT linear probe single-seed run.
...
def parse_args():
    parser = argparse.ArgumentParser(description="MERT linear probe single-seed runner")
...
def main():
    ...
    print(f"=== MERT Linear Probe — {seed_name} (seed={base_seed}) ===")
    ...
    print(f"  MERT linear probe {seed_name}: DONE")
